...
export function ThemeProvider({ children }) {
  ...
  useEffect(() => {
    // Les variables de couleur sont declarees sur `.mg-admin` (theme.css) et
    // non plus sur :root, pour ne pas deteindre sur le site vitrine. La
    // couleur d'accent doit donc etre posee sur ce meme conteneur : ecrite
    // sur <html>, elle serait masquee par la declaration de `.mg-admin`.
    const root = document.querySelector('.mg-admin') || document.documentElement;
    if (accent) {
