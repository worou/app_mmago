...
// Variable distincte de VITE_API_URL : celle-ci vise l'API Laravel du site
// vitrine, alors que le back-office parle a l'API PHP. Les deux backends
// coexistent, l'application unifiee doit donc pouvoir viser les deux.
const BASE = import.meta.env.VITE_ADMIN_API_URL || 'http://localhost/mamago/api';
