...
createRoot(document.getElementById('root')!).render(
  <StrictMode>
    <BrowserRouter>
      <Routes>
        {/*
          Le back-office, monte hors de l'arbre localise : il n'est pas
          traduit et ne doit pas exister en double sous /en. Son propre
          routeur prend la suite via le joker.
        */}
